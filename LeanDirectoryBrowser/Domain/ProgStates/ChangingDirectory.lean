...
def getChangingDirectoryCodeList (ps : ProgState) (_: isProgStateChangingDirectory ps) : List Code :=
  [
...
def processChangingDirectory (ps : ProgState) (_ : isProgStateChangingDirectory ps) (input : String) : ProgState :=
  match ps with
...
def withLoadedChildrenChangingDirectory (ps : ProgState) (_: isProgStateChangingDirectory ps) : IO ProgState :=
  match ps with
