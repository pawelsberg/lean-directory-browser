...
namespace HeightProvided
  def getCodeList (ps : ProgState) (_: isProgStateHeightProvided ps) : List Code :=
    match ps with
  ...
  def process (ps : ProgState) (_ : isProgStateHeightProvided ps) (input : String) : ProgState :=
    match ps with
